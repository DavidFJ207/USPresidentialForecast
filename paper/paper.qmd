...
#| fig-cap: Demographic Differences Between Maryland and South Dakota
#| echo: false
#| warning: false
#| message: false
...
prepare_plot_data <- function(diff_df, top_n = 6) {
  ...
  top_diff_vars %>%
    ...
    mutate(Group = recode(Group, "Blue_Mean" = "Maryland", "Red_Mean" = "South Dakota"))
}
...
create_comparison_plot <- function(plot_data) {
  ggplot(plot_data, aes(
    ...
    scale_fill_manual(values = c("Maryland" = "blue", "South Dakota" = "red")) +
    labs(
      title = "Demographic Differences Between Maryland and South Dakota",
...
analyze_state_differences <- function(data, blue_state, red_state, top_n_vars = 4) {
...
# Run the analysis for Maryland and South Dakota
analysis_results <- analyze_state_differences(poll_summary, blue_state = "Maryland", red_state = "South Dakota", top_n_vars = 5)
